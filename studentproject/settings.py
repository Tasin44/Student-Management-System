...
SECRET_KEY = 'django-insecure-0@d27ak+**+(9puxg+o6q^rjynwoizuqbj-$jj9k5_lkxu(wt2'
...
DATABASES = {
  ...
  'NAME': 'Student-management-system',#db name what i make new db in pgadmin for that project
...
AUTH_USER_MODEL = 'authenticationapp.CustomUser'  # Adjust 'home_auth' to the app where CustomUser is defined
